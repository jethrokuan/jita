...
# Number of bits to grab from the front of the hash in the fingerprint
# calculation. The more you grab, the more memory storage, with potentially
# lesser collisions of matches.
